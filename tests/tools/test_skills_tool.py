...
class TestSkillViewSecureSetupOnLoad:
    ...
    def test_allows_skipping_secure_and_still_loads(self, tmp_path, monkeypatch):
        monkeypatch.delenv("TENOR_API_KEY", raising=False)
...
class TestSkillViewPrerequisites:
    ...
    def test_no_setup_needed_when_legacy_prereqs_are(self, tmp_path, monkeypatch):
...
""",
    ...
    def test_successful_secret_capture_empty_env_placeholder(
        self, tmp_path, monkeypatch
    ):
        monkeypatch.setenv("TERMINAL_ENV", "local")
        monkeypatch.delenv("TENOR_API_KEY", raising=False)
